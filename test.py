...
GEMINI_API_KEY = os.getenv("AIzaSyDhhCTCv4BSaHWg6anhB4Y4qWpVRfAyJe8") # Get the key securely from the environment
...
BASE_SONG_PATH = r"C:\Users\ksuma\Desktop\project x\songs"
